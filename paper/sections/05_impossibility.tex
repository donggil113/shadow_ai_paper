...
\cref{sec:experiments} the bound is valid in every one of 30 configurations, is
exactly $1$ when the mechanism really is missing-at-random, and recovers
$34$--$61\%$ of $\log\Gamma_0$ --- less when decision makers differ in \emph{how
much} they rely on private information rather than only in how lenient they are,
which is exactly what makes their identified sets overlap at a smaller $\Gamma$.
